...
sr.reveal(
  `.home__data, .home__social-link, .home__info, .discover__container, .experience__data, .experience__overlay, .places__card, .sponsors__content, footer__data, .footer__rights`,
  {
    origin: "top",
    interval: 100,
  }
